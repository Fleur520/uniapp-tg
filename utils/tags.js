        ...
        },
        {
            ...
            "item_info": {
                ...
                "article_info": {
                    ...
                    "is_gfw": 0,
                    "title": "3C模型",
                    "brief_content": "3C模型包括了3个维度： Capability 能力：你是否有足够的能力为客户服务， 或你的产品是否足够好 Compatibility 匹配：你的产品或服务能否匹配客户 的需求 Confidence 信心：你能否让客户相信，用了你的产品 /服务能带来好的结果 而这3C里面，哪个C更加重要呢？是Compatibility,也 就是匹配。只有当需求对了，接下来才是你的产品/服 务如何地好。",
                    "is_english": 0,
                    "is_original": 1,
        ...
        },
        {
            ...
            "item_info": {
                ...
                "article_info": {
                    ...
                    "is_gfw": 0,
                    "title": "SWOT分析模型",
                    "brief_content": "先分为内外部两大因素，接着内容从S-优势 (strengths)、W0威胁(weaknesses)进行分析，外部从 O-机会(opportunities)、T-威胁(threats)进行分析",
                    "is_english": 0,
                    "is_original": 1,
        ...
        },
        {
            ...
            "item_info": {
                ...
                "author_user_info": {
                    ...
                    "level": 1,
                    "description": "擅长C/C++、PostgreSQL数据库、编译原理、数据结构&算法、、TCP/IP",
                    "followee_count": 0,
                    "follower_count": 8,
    ...
    "data": [
        {
            ...
            "article_info": {
                ...
                "is_gfw": 0,
                "title": "冰山模型",
                "brief_content": "这个模型，包括3个层面6大维度。它是几乎所有大公 司用来做人才招聘、培养的基础模型，所以学完这个 模型之后，你还能顺便知道，公司给你的薪酬是根据 什么来定的。",
                "is_english": 0,
                "is_original": 1,
                "user_index": 5.9139374137187,
                "original_type": 0,
        ...
        },
        {
            ...
            "article_info": {
                ...
                "is_gfw": 0,
                "title": "Kano模型",
                "brief_content": "将需求分为了五个层次： 1）基本需求-是一个基本门槛，不满足则不会让用户 满意； 2）期望需求-用户期望的需求，被满足的越多，满意 度越高； 3）兴奋需求-用户不存在预期的，但是有了之后会让 用户兴奋的需； 4）无差异需求-对用户满意度没有影响的需求； 5）反向需求-有了之后会降低用户满意度的需求",
                "is_english": 0,
                "is_original": 1,
                "user_index": 0,
                "original_type": 0,
