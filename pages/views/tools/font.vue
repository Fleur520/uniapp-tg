<template>
	<view class="tools">
		<u-input v-model="value" type="textarea" :border="true" height="200" :auto-height="true" />
		<view class="btns">
			<view class="btn" @tap="tansfer(1)">繁体转换为简体</view>
			<view class="btn" @tap="tansfer(2)">简体转换为繁体</view>
			<view class="btn" @tap="tansfer(3)">转换为火星文</view>
		</view>
		<u-input v-model="result" placeholder="匹配结果" type="textarea" :border="true" height="200" :auto-height="true" />
	</view>
</template>
		...
		methods: {
			...
			jtgo(cc) {
				...
				for (var i = 0; i < cc.length; i++) {
					if (this.charft().indexOf(cc.charAt(i)) != -1) str += this.charjt().charAt(this.charft().indexOf(cc.charAt(i)));
					else if (this.charhx().indexOf(cc.charAt(i)) != -1) str += this.charjt().charAt(this.charhx().indexOf(cc.charAt(i)));
			...
			ftgo(cc) {
				var str = '';
				for (var i = 0; i < cc.length; i++) {
					if (this.charjt().indexOf(cc.charAt(i)) != -1) str += this.charft().charAt(this.charjt().indexOf(cc.charAt(i)));
					else if (this.charhx().indexOf(cc.charAt(i)) != -1) str += this.charft().charAt(this.charhx().indexOf(cc.charAt(i)));
					else str += cc.charAt(i);
				}
				return str;
			},
			qqgo(cc) {
				var str = '';
				for (var i = 0; i < cc.length; i++) {
					if (this.charjt().indexOf(cc.charAt(i)) != -1) str += this.charhx().charAt(this.charjt().indexOf(cc.charAt(i)));
					else if (this.charft().indexOf(cc.charAt(i)) != -1) str += this.charhx().charAt(this.charft().indexOf(cc.charAt(i)));
					else str += cc.charAt(i);
				}
				return str;
			},
